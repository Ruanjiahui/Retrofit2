...
/**
 * Created by 19820 on 2018/4/20.
 */

public class NetWorkChargeReceiver extends BroadcastReceiver {

    private static String TAG = "NetWorkChargeReceiver:";
        ...
        if (WifiManager.NETWORK_STATE_CHANGED_ACTION.equals(intent.getAction())) {
            ...
            if (null != parcelableExtra) {
                ...
                if (isConnected) {
                    ...
                    Toast.makeText(context , networkInfo.getExtraInfo() , Toast.LENGTH_SHORT).show();
                } else {
