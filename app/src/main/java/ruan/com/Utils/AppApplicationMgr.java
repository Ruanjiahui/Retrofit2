...
public class AppApplicationMgr {
    ...
    public static LogFactory factory = LogFactory.getInstance(AppApplicationMgr.class);
    ...
    public static String getVersionName(Context context) {
        ...
        try {
            ...
            factory.i("getVersionName" , "AppApplicationMgr-->>getVerName() " + e.getMessage() + "获取本地Apk版本名称失败！");
            e.printStackTrace();
        }
        return verName;
    }
    ...
    public static int getVersionCode(Context context) {
        ...
        try {
            ...
            factory.i("getVersionCode" , "AppApplicationMgr-->>getVerCode()" + e.getMessage() + "获取本地Apk版本号失败！");
            e.printStackTrace();
        }
        return verCode;
    }
